  ...
  (d.prototype = {
    ...
    place: function () {
      if (!this.isInline) {
        ...
        "auto" === q &&
          ((o = -h + j.top - d), (p = h + g - (j.top + k + d)), (q = Math.max(o, p) === p ? "top" : "bottom")),
    ...
    setDefaultTime: function (a) {
      if (this.$element.val()) this.updateFromElementVal();
        ...
        var b = new Date(),
          ...
          f = "AM";
        0 !== e &&
          ((e = Math.ceil(b.getSeconds() / this.secondStep) * this.secondStep), 60 === e && ((d += 1), (e = 0))),
          0 !== d &&
            ((d = Math.ceil(b.getMinutes() / this.minuteStep) * this.minuteStep), 60 === d && ((c += 1), (d = 0))),
