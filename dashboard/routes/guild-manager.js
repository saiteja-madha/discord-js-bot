...
router.post('/:serverID/basic', CheckAuth, async (req, res) => {
  ...
  if (Object.prototype.hasOwnProperty.call(data, 'statsUpdate')) {
    ...
    data.levelup_channel =
      guild.channels.cache.find(ch => '#' + ch.name === data.levelup_channel)
        ?.id || null
  ...
  if (Object.prototype.hasOwnProperty.call(data, 'ticketUpdate')) {
    ...
    data.channel = guild.channels.cache.find(
  ...
  if (Object.prototype.hasOwnProperty.call(data, 'automodUpdate')) {
    ...
    if (
      data.automod_action &&
      data.automod_action !== settings.automod.action
    ) {
    ...
    if (
      data.anti_attachments !== (settings.automod.anti_attachments || false)
    ) {
    ...
    if (
      data.anti_massmention !== (settings.automod.anti_massmention || false)
    ) {
...
router.post('/:serverID/greeting', CheckAuth, async (req, res) => {
  ...
  if (
    ...
    if (
      data.description &&
      data.description !== settings.welcome.embed?.description
    ) {
      settings.welcome.embed.description = data.description
    }
  ...
  if (
    ...
    if (
      data.description &&
      data.description !== settings.farewell.embed?.description
    ) {
